package com.incubasys.formblok.custom.wheelview.lib;
...
import com.incubasys.formblok.custom.wheelview.adapter.WheelAdapter;
import com.incubasys.formblok.custom.wheelview.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            @SuppressLint({"CustomViewStyleable", "Recycle"}) TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.wheelview, 0, 0);
    ...
    void smoothScroll(ACTION action) {
        ...
        mFuture = mExecutor.scheduleWithFixedDelay(new SmoothScrollTimerTask(this, mOffset), 0, 2, TimeUnit.MILLISECONDS);
    }
    ...
    public final void setSelectedFont(@NonNull Typeface typeface) {
        paintCenterText.setTypeface(typeface);
    }

    public final void setOuterFont(@NonNull Typeface typeface) {
